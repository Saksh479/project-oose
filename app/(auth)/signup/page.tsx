        ...
        <div className="pt-32 pb-12 md:pt-40 md:pb-20">
          ...
          <div className="max-w-sm mx-auto">
            ...
            <form>
              ...
              <div className="flex flex-wrap -mx-3 mb-4">
                <div className="w-full px-3">
                  <label className="block text-gray-300 text-sm font-medium mb-1" htmlFor="company-name">University<span className="text-red-600">*</span></label>
              ...
              <div className="text-sm text-gray-500 text-center">
                I agree to be contacted by Schoogle.co about this offer as per the Schoogle <Link href="#" className="underline text-gray-400 hover:text-gray-200 hover:no-underline transition duration-150 ease-in-out">Privacy Policy</Link>.
              </div>
            ...
            <div className="text-gray-400 text-center mt-6">
              Already using Schoogle? <Link href="/signin" className="text-purple-600 hover:text-gray-200 transition duration-150 ease-in-out">Sign in</Link>
            </div>
          </div>
